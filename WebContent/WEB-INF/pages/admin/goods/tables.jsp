						...
						<div class="col-xs-12">
															...
															<div class="col-xs-12 col-sm-2">
																<div class="text-center">
																	<img height="150"
																		...
																		src="<%=basePath%>images/avatars/profile-pic.jpg" />
																	<br />
																	<div
							...
							<h4 class="pink">
								...
								<a href="#modal-table" role="button" class="green"
									data-toggle="modal"> Table Inside a Modal Box </a>
							</h4>
...
<![endif]-->
	...
	<script src="<%=basePath%>js/jquery.dataTables.bootstrap.min.js"></script>
	...
	<script src="<%=basePath%>js/buttons.colVis.min.js"></script>
